...
public class MyStuff extends AutomaticsTestBase{
	...
	@TestDetails(testUID = "TC-RDKV-STB-1013")  
	public void testVerifyMystuff(Dut device) { 
		// Variables declaration starts
		boolean status = false;
		String testId = "TC-RDKV-STB-013"; 
		...
		LOGGER.info("TEST DESCRIPTION: Verify the Peacock My stuff screen matches with the reference image");
		LOGGER.info("TEST STEPS : ");
		LOGGER.info("1. Verify the Peacock My stuff with reference image");
		LOGGER.info("#######################################################################################");
		...
		//	BufferedImage originalImg = ImageIO.read(new File(ConstantsSTB.REFRENCE_IMAGE_PATH));
			...
			try {
				...
				LOGGER.info("*****************************************************************************************");
				LOGGER.info("STEP 1: DESCRIPTION : Verify the Peacock Mystuff screen with reference image.");
				...
				reference_image = ImageIO.read(new File(ReferenceImageConstants.PEACOCK_MYSTUFF_REFERENCE_IMG)); 
				
				live_Image = ImageIO.read(new File(ReferenceImageConstants.PEACOCK_MYSTUFF_LIVE_IMG)); 
